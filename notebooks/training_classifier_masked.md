...
'wandb_project_name = "wandb_transformer_interpretability_project"' 'exp_name = "ImageNette_classifier_masked_vit_small_patch16_224_1e-5_train"' \
...
# train classifier
python main.py with 'stage = "classifier_masked"' \
'wandb_project_name = "wandb_transformer_interpretability_project"' 'exp_name = "ImageNette_classifier_masked_vit_base_patch16_224_1e-5_train"' \
env_chanwkim 'gpus_classifier=[0]' \
dataset_ImageNette \

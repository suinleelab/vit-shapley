...
class BaseCAM:
    ...
    def forward(self,
                input_tensor: torch.Tensor,
                targets: List[torch.nn.Module],
                eigen_smooth: bool = False, resize=True) -> np.ndarray:
    ...
    def compute_cam_per_layer(
            ...
            input_tensor: torch.Tensor,
            targets: List[torch.nn.Module],
            eigen_smooth: bool, resize: bool) -> np.ndarray:
    ...
    def __call__(self,
                 ...
                 eigen_smooth: bool = False, resize: bool = True) -> np.ndarray:

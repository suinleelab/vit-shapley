...
from utils.transformer_explainability.baselines.ViT.helpers import load_pretrained
from utils.transformer_explainability.baselines.ViT.layer_helpers import to_2tuple
from utils.transformer_explainability.baselines.ViT.weight_init import trunc_normal_
from utils.transformer_explainability.modules.layers_ours import *
...
def vit_small_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
        patch_size=16, embed_dim=384, depth=12, num_heads=6, qkv_bias=True, **kwargs)

...
from . import utils, games, stochastic_games
...
def ShapleyRegression(game,
    ...
    print('min_variance_samples:', min_variance_samples)
    ...
    print('n_samples:', n_samples, 'n_loops', n_loops)
    if bar:
        if detect_convergence:
            bar = tqdm(total=1)
        else:
